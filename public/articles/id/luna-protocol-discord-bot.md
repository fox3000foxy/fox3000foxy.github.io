...
description: "Luna Protocol adalah bot Discord yang sepenuhnya otonom dengan LLM lokal, mampu percakapan alami dengan tidur, kesalahan ketik, keraguan, kelupaan, kelelahan tematik, dan pesan spontan."
date: 2026-07-11
tags:
  - discord-bot
  - llm
  - typescript
  - arsitektur-peristiwa
  - kecerdasan-buatan
  - sumber-terbuka
authors:
  - fox3000foxy
author_pubkey: "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEQcreZmmVx1U8zFHwsD+JTDIUKtMP5RYijaEkOIqZVfXIKA/i3h0lslw+ZgUBlLXKW3OVA2tGM8svcJWTXDxS8A=="
author_sig: "MiQIaaadQ8f0fM2V7S0MpEtLAD5rqg1ts4MZyQyKMuYcOdfvM+vT0ooJsUHTl+wv8G5ZaJCqyoGIH+GaPfAq3Q=="
---

# Luna Protocol: Saya membuat bot Discord otonom yang mensimulasikan manusia
Bagaimana jika bot Discord bisa **tidur**, melakukan **kesalahan ketik**, **ragu-ragu**, **lupa** membalas, dan terkadang mengirim pesan atas inisiatifnya sendiri? Itulah yang dilakukan **Luna Protocol**: bot Discord sepenuhnya otonom yang menjalankan LLM lokal (llama.cpp) dan mengobrol seperti manusia yang tidak sempurna.
Tanpa prompt kaku, tanpa jawaban robotik. Luna memiliki **sistem pemicu prioritas**, **penundaan variabel**, **jadwal tidur**, **pesan spontan**, bahkan **pipeline TTS** untuk mengirim pesan suara. Semuanya dapat dikonfigurasi melalui satu file `config.yml` yang dapat di-hot-reload.
Dalam artikel ini, kita membedah arsitektur lengkap: dari bus event generik hingga pipeline TTS, termasuk sistem pemicu, komponen manusia, dan dataset fine-tuning.
![Tinjauan Arsitektur -- komponen global dan alur data](/images/luna-protocol/01-architecture-overview.svg)

---

## Arsitektur: bus peristiwa bertipe
...
Bot mengirim permintaan langsung ke `llama-server` lokal via HTTP. Model dibagi, dengan prompt cache dan 4 slot bersamaan. Dua proses PM2: server LLM dan client bot.
...
Folder `state-machines/` berisi **24 diagram Mermaid** yang mencakup seluruh kode sumber. Setiap diagram memiliki penjelasan detail dalam bahasa manusia.
