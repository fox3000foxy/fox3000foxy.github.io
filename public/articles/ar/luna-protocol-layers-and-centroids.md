...
- `futile_centroid`: متوسط تضمين ~500 رسالة تافهة ("lol"، "ok"، "hello"، "nm just chillin u")
- `interesting_centroid`: متوسط تضمين ~550 رسالة جوهرية (أسئلة تقنية، اعترافات، فلسفة)
...
يُعرض مثالان باللون الأحمر: "lol" (مصنَّفة تافهة) و"i feel sad today" (مصنَّفة مثيرة). "lol" تقع ضمن السحابة الزرقاء للرسائل التافهة، بينما "i feel sad today" تقع في جانب النقاط الصفراء. الفصل واضح حتى بعد الاختزال إلى 3 أبعاد (15.6% فقط من التباين الكلي مُفسَّر). في 384 بُعدًا، يكون الحد أكثر وضوحًا بكثير.
