...
author_sig: "NrZKmxYYmZg+dWzV80O4hwKJHYzOmM7gkRwqYPXV1tWqvvsbEDndHRO6+M2ahkX/dHuvReF4oDCT8SvyFBBotA=="
---
...
유전 알고리즘은 **진화론**의 시뮬레이션이다. 핵심 아이디어: 약간 다른 특성("유전자")을 가진 **개체군**을 만들고, 환경에서 "살게" 한다. 가장 잘适应한 개체는 생존하고 번식한다. 적응하지 못하는 개체는 도태된다.
...
![AI가 제어하는 마리오가 슈퍼 마리오 월드 레벨에서 부와 대峙 -- 신경망이 실시간으로 행동을 결정](/images/laupok-mario-ai/mario-ai-playing.jpg)
...
- **이해 없음**: AI는自己가 하는 일을 "이해하지" 못한다. 무작위 돌연변이를 통해 적합도 함수(이동 거리)를 최적화할 뿐
