...
Всё это хостится на **GitHub Pages** напрямую из репозитория `fox3000foxy/blog`.
...
Если ты хочешь создать свой собственный блог с похожей архитектурой, загляни в [исходный код на GitHub](https://github.com/fox3000foxy/blog)!
