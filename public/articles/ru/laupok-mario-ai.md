...
description: >
  Подробный разбор проекта Laupok: ИИ на основе алгоритма NEAT, который учится
  играть в Super Mario World автономно. Генетические алгоритмы, нейронные сети,
  нейроэволюция расширяющих топологий и 4200 строк на Lua.
date: 2026-07-11
tags:
...
author_sig: "VlT7gefCSFeg2eImDumhaFZhzCwK+QlYVhy5FlVYnmUHyTsvsQiLj2wUnNuwKT3ZqjfOXmJA1TjtHMgO2vemEg=="
---
