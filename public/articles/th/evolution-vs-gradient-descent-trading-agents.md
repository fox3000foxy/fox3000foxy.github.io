...
author_sig: "49b/We1Du9DsbKdG9FElPX0kpvs1prkzt0mYGf0cavoKiS5Ia9lQddig8OmNJuys+7xoqpAwyYpvgGi9OOuJZw=="
---
...
การเปลี่ยนแปลงนี้เพียงอย่างเดียวทำให้ฟิตเนสเฉลี่ยของประชากรลดลง; สัญญาณว่าส่วนใหญ่ของสิ่งที่ดูเหมือนประสิทธิภาพใน v1 เป็นการจดจำล้วนๆ เ� دردที่ต้องเห็น แต่มันเป็นสัญญาณที่คุณต้องการ: คะแนนที่ต่ำกว่าแต่ซื่อสัตย์ดีกว่าคะแนนที่สูงเกินจริงและทำให้เข้าใจผิด
...
*   **ความหลากหลายของสภาพแวดล้อม**: จีโนมแต่ละตัว不再ถูกประเมินบนหน้าต่างตลาดเดียว แต่บนหลายหน้าต่าง ที่ดึงจากสภาวะต่างๆ (ขาขึ้น, ขาลง, sideways) เอเยนต์ที่เก่งในหน้าต่างหนึ่งและพังในอีกหน้าต่างไม่สามารถครอบงำแนวหน้า Pareto ได้อีกต่อไป
