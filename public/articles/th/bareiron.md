...
author_sig: "MEUCIQC3fpCjzKt+yFZCTiJci8QOw6vwzYRweZL4MUAasdC6/gIgPHk69Yl4v1hyft9YecsjMRPglodDo2w1zettbOXSljU="
---
...
แต่ละไบโอมถูกเข้ารหัสใน **3 อาร์เรย์ 5 รายการ**: ความสูงพื้นฐาน, บล็อกพื้นผิว, จำนวนปัจจัย. เมื่อ `getHeightAtFromHash` ได้รับไบโอม, มันจะ查阅อาร์เรย์เหล่านี้เพื่อปรับ terrain. ข้อมูล 15 bytes เพื่อแทนที่ระบบไบโอมทั้งหมดของ Minecraft
