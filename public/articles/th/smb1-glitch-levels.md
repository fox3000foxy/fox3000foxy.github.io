...
author_sig: "MEQCIHHrjxB418JMXyFbmggdBs56yc3y2NfVlOwMTMcrqg9eAiBsXFN4xab1kCNH4xJLwDxULv6/8WztxE5xaFwMg1e2zA=="
---
...
ผลลัพธ์: ไม่มีอะไร เกมโหลดเลเวลแต่มันถูกทำเครื่องหมายว่า "ไม่มีเลเวล" ในแคタลอกของ RGMechEx tiles อาจถูกต้องแต่ sprites ชี้ไปยังตำแหน่งที่สร้างเลเวลว่างเปล่าหรือใช้งานไม่ได้
...
พอร์ตโดยตรงพร้อมรู틴 6502 เดียวกัน (SNES รันโค้ด NES ในโหมดที่เข้ากันได้):
