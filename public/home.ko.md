...
[RSS 피드](/feed.xml)를 구독하고 새 글을 확인해라. 피드는 사용 가능한 모든 언어의 글을 포함한다.

<a href="/feed.xml" style="display:inline-flex;align-items:center;gap:0.5rem;background:#ff6600;color:#fff;padding:0.5rem 1rem;border-radius:6px;text-decoration:none;font-weight:600;font-size:0.9rem;">📡 RSS 구독하기</a>
