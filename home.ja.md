...
私は工夫深いんです -- 高価な既存の解決策ではなく、自分で考えたニッチで無料の方法をいつも見つけ出します。例えば [Nibi](https://github.com/Let-s-Learn-Japanese-Together/Nibi) は、コマンド管理、データベース管理、デーモンに対して無料の回避策を見つけた最新の作品のひとつ。それに GitHub Actions とワークフローで遊ぶのは最高の気分だよ。SSH キーでコミットに署名し始めて、そのスクリプトは [この gist](https://gist.github.com/fox3000foxy/95500d129cd4bf5c173c323d2492569a) で公開してる。
...
JavaScript の原理はかなり理解してる。だって8歳の頃から JavaScript でコードを書いてるからね。😄 自慢したいわけじゃないよ。もっと悪い状況で俺よりすごい開発者もいれば、完全な詐欺師なのに俺より稼いでる人もいるってわかってるから。
...
自分の情熱についてブログ記事をまるごと書いたよ----コーディング、絵を描くこと、自動化、古い技術の発見、などなど。読むならここ： [俺の情熱](/blog/my-passions)

## パッケージ

たまに npm パッケージを書いてる。[fetch-tor-proxy](https://www.npmjs.com/package/fetch-tor-proxy) とか [fake-data-npm](https://www.npmjs.com/package/fake-data-npm) とか。誰にも使われてないし、俺自身も使ってないけど、いつか爆発的に流行ってほしい！

## プロジェクト

~~プロジェクトがめちゃくちゃ多いんだ。今は全部で158のリポジトリがあって、そのうち108が公開！ おそらくブログセクションで紹介すると思う。~~

~~注：プライベートリポジトリもたくさんあって、それについては話したくない。でも、主に世界と共有したくないプロジェクトとか、まだ完成してないやつとか、ただの趣味で俺以外には全然役に立たないものだよ。~~

~~プロジェクトは[プロジェクトページ](/projects)と[GitHub プロフィール](https://github.com/fox3000foxy)で見られるよ。~~
...
このブログでは、進捗や考え、共有したいことを何でも発信していくよ。そうすればみんなが俺の考え方をわかってくれる。要するに、GitHub は全プロジェクトとそのリアルタイムの進捗をリストアップする場所になる。プロジェクトの年齢が大好きなんだ。自分のリポジトリの日付が古くなっていくのを見るのが好きでね。だからプロフィールのコミット日付が改ざんされてても不思議じゃない！ 😁
