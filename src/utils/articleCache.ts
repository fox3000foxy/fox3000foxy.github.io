...
export async function fetchMarkdown(key: string, url: string): Promise<string | null> {
...
export async function fetchArticleMarkdown(slug: string): Promise<string | null> {
...
export function prefetchMarkdownEntries(entries: {key: string; url: string}[]): void {
